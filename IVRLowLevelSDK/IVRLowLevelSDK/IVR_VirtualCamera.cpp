...
bool CIVRVirtualCamera::IVR_RecordBuffer(const IVR_RenderBuffer &pIVR_FrameBuffer,const IVR_FrameData &pIVR_FrameData)
{
    ...
    {
       IVR_Takes[IVR_ActualTake]->IVR_RenderQueue->push(pIVR_FrameBuffer);
       IVR_Takes[IVR_ActualTake]->IVR_DataQueue->push(pIVR_FrameData);
    });
